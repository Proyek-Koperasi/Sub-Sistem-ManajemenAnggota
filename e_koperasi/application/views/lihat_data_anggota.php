                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class='text-center'>
                                    <div class='btn-group'>
                                      <a href="<?php echo base_url(); ?>c_admin/detail_anggota/<?php echo $row->id_anggota; ?>" class='btn btn-info'>
                                        <i class="fa fa-tasks"></i>
                                      </a>
                                      <a href="<?php echo base_url(); ?>c_admin/edit_anggota_sup/<?php echo $row->id_anggota; ?>" class='btn btn-warning'>
