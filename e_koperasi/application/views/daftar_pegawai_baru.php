    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          <form action="<?=base_url();?>index.php/c_admin/ProsesRegisterPegawai/" enctype="multipart/form-data" method="post">
            <div class="panel-body">
             ...
             <div class="panel-body">
              <div class="row control-group">
                <div class="form-group">
                  <label class="col-sm-2 control-label">Level Pegawai</label>
                  <div class="col-sm-7">
