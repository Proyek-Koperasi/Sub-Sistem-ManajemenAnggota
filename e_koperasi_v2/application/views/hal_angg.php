...
<table border="0" align="center" class="table responsive">
  ...
  <tr>
    ...
    <tr>
      <th width="153" scope="row"><button type="button" class="btn btn-lg btn-success"  onClick="window.location.href='<?=base_url();?>index.php/Halamananggota/updatePhoto/<?=$Array['id_anggota']?>'">Change Photo</button></th>
