      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
                ...
                <section class="content-header">
                  <h4>
                    Detail 
                    <small>Data Anggota Aktif</small>
                  </h4>
                </section>
...
<table border="0" align="center" class="table responsive">
 ...
 <input name="ktp" type="hidden" class="form-control" value="<?=$Array['ktp_ang']?>" placeholder="" readonly/>
      <th scope="row"><div align="right"><input type="button" value="Back" onClick="window.location.href='<?=base_url();?>c_admin/a_view_anggota'" class="btn btn-lg btn-success">
      </div></th>
